...
def get_ip_from_subnet(ip):
    ...
    try:
        ...
        return None, None
def get_ip_from_csv():
    with open(r"C:\Users\John\Documents\John\CyberMe\Python\YT-GetIPFromRanges\IpRanges.csv", mode = 'r')as file:
...
def main():
    ...
    write_to_text(r'C:\Users\John\Documents\John\CyberMe\Python\YT-GetIPFromRanges\finallist.csv',finaliplist)
